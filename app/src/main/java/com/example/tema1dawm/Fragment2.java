...
public class Fragment2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(continent.equals("Asia")) {
            frameLayout.setBackgroundColor(Color.parseColor("#E20202"));
            lineTextView.setRotation(90);
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            params.setMargins(0,200,0,0);
            nameTextView.setLayoutParams(params);
            continentTextView.setLayoutParams(params);
        ...
        if(continent.equals("South America") || continent.equals("North America")) {
